//CODIGO PRINCIPAL PARA VALORES ESTANDAR DRON 4M
...
int led_time=100;
 pinMode(15, OUTPUT);
  ...
  delay(1000);
  mot1.attach(mot1_pin,900,2000);
  delay(1000);
  mot1.setPeriodHertz(ESCfreq);
  delay(100);
  mot2.attach(mot2_pin,900,2000);
  delay(1000);
  mot2.setPeriodHertz(ESCfreq);
  delay(100);
  mot3.attach(mot3_pin,900,2000);
  delay(1000);
  mot3.setPeriodHertz(ESCfreq);
  delay(100);
  mot4.attach(mot4_pin,900,2000);
  delay(1000);
...
RateCalibrationRoll=-3.24;
RateCalibrationPitch=2.32;
RateCalibrationYaw=-0.26;
